...
#corr, _ = spearmanr(obs_ch4.values, mod_ch4.values)
corr, _ = pearsonr(obs.values, mod_ch4.values)
...
for l in axs['main']['date1'].get_xticklabels():
    l.set_ha("right")
    l.set_rotation(30)
figs['main'].savefig(os.path.join('outputs/validation_ch4/timeseries_2018.png'))
